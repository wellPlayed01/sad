...
<input type="hidden" name="id" value="hidid">       
        ...
        <input type="text" class="form-control" name="unit" value="<?php echo $_POST['hidun']; ?>">
<input type="hidden" name="unhid" value="hidun">
<p>Shortcut: </p><input type="text" class="form-control" name="short" value="<?php echo $_POST['hidshort']; ?>">
        <input type="hidden" name="shorthid" value="hidshort">
...
if(isset($_POST['btnUpdate']))
{
            ...
            $un=$_POST['unit'];
            $short=$_POST['short'];
    mysql_query("update unit_tbl set Unit= '$un',Shortcut= '$short' where unit_id= '$hid'");
   ...
   if(isset($_POST['btnDelete']))
    ...
    <?php
            ...
            {
            $hid = $_POST['id'];
            mysql_query("delete from unit_tbl where unit_id='$hid'")or die(mysql_error());
            echo "Record Deleted";
            }
...
<td>    <form method="post" action="unit_edit.php">
