...
<input type="hidden" name="id" value="hidid">       
        <p>Category Name:</p> 
        <input type="text" class="form-control" name="name" value="<?php echo $_POST['hidcat']; ?>">
...
if(isset($_POST['btnUpdate']))
{
            ...
            $cat=$_POST['hidcat'];
            $desc=$_POST['hiddesc'];
    mysql_query("update category_tbl set Category= '$cat',Description= '$desc' where category_id= '$hid'");
   ...
   if(isset($_POST['btnDelete']))
    ...
    <?php
            ...
            {
            $hid = $_POST['id'];
            mysql_query("delete from category_tbl where cat_id='$hid'")or die(mysql_error());
            echo "Record Deleted";
            }
