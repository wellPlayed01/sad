...
<input type="hidden" name="id" value="hidid">       
        <p>Variant Name:</p> 
        <input type="text" class="form-control" name="name" value="<?php echo $_POST['hidvar']; ?>">
<input type="hidden" name="varhid" value="hidvar">
...
if(isset($_POST['btnUpdate']))
{
            ...
            $var=$_POST['hidvar'];
            $desc=$_POST['hiddesc'];
    mysql_query("update variant_tbl set Category= '$var',Description= '$desc' where category_id= '$hid'");
   ...
   if(isset($_POST['btnDelete']))
    ...
    <?php
            ...
            {
            $hid = $_POST['id'];
            mysql_query("delete from variant_tbl where cat_id='$hid'")or die(mysql_error());
            echo "Record Deleted";
            }
