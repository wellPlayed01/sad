...
<input type="hidden" name="id" value="hidid">       
        <p>Packaging:</p> 
        <input type="text" class="form-control" name="pack" value="<?php echo $_POST['hidpack']; ?>">
<input type="hidden" name="packhid" value="hidpack">
<p>Description: </p><input type="text" class="form-control" name="desc" value="<?php echo $_POST['hiddesc']; ?>">
        <input type="hidden" name="desc" value="hiddesc">
...
if(isset($_POST['btnUpdate']))
{
            ...
            $pack=$_POST['packhid'];
            $desc=$_POST['desc'];
    mysql_query("update packaging_tbl set Packaging= '$pack',Description= '$desc' where pack_id= '$hid'");
   ...
   if(isset($_POST['btnDelete']))
    ...
    <?php
            ...
            {
            $hid = $_POST['id'];
            mysql_query("delete from packaging_tbl where pack_id='$hid'")or die(mysql_error());
            echo "Record Deleted";
            }
...
<td>    <form method="post" action="packaging_edit.php">
